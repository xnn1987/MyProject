...
public class XCSlideMenu extends HorizontalScrollView{
    ...
    public static final int RIGHT_PADDING = 65;
    public static final int MIN_PADDING = 150;//往左滑的最小距离
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        Log.i("switchMenu","222222222222="+MyApplication.isHorizontalScroll);
            return false;
            ...
            case MotionEvent.ACTION_UP:
                ...
                int scrollX = getScrollX();
                    if(scrollX >= mMenuWidth /2){
                        ...
                        Log.i("switchMenu","222222222222");
                    }else{
                        //Menu 右滑 显示出来
                        this.smoothScrollTo(0, 0);
                        isSlideOut = true;
                        Log.i("switchMenu","11111111111");
                        MyApplication.isLeft=true;
                        tintManager.setNavigationBarTintEnabled(false);
                        tintManager.setStatusBarTintEnabled(true);
                        tintManager.setTintResource(R.color.aixiyi_center_txt_blue);
                        this.setBackgroundColor(mContext.getResources().getColor(R.color.aixiyi_center_txt_blue));
                    }
                    return true;
        }
