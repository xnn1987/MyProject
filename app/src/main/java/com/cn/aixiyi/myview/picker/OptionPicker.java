...
public class OptionPicker extends WheelPicker {
    ...
    protected View makeCenterView() {
        ...
        WheelViews optionView = new WheelViews(activity);
        ...
        optionView.setOnWheelViewListener(new WheelViews.OnWheelViewListener() {
            @Override
    ...
    public void onSubmit() {
        if (onOptionPickListener != null) {
            onOptionPickListener.onOptionPicked(selectedOption,selectedIndexInt);
        }
    }
