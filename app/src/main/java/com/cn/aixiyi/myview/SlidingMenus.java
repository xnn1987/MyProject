...
public class SlidingMenus extends RelativeLayout {
	...
	public boolean hasClickRight = false;
	...
	public SlidingMenus(Context context, AttributeSet attrs, int defStyle) {
...
//		setCenterView(center);
	...
	public boolean leftOpened(){
		return mSlidingView.getScrollX() == -mLeftView.getWidth();
	}
	...
	public void showLeftView() {
		...
		int oldScrollX = mSlidingView.getScrollX();
		Log.i("SlidingMenu", "menuWidth: " + menuWidth);
		if (oldScrollX == 0) {
			mLeftView.setVisibility(View.VISIBLE);
			mRightView.setVisibility(View.INVISIBLE);
