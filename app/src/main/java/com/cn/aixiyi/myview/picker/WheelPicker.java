package com.cn.aixiyi.myview.picker;
...
import com.cn.aixiyi.myview.popup.ConfirmPopup;
...
public abstract class WheelPicker extends ConfirmPopup<View> {
     ...
     * The Text size.
     */
    protected int textSize = WheelViews.TEXT_SIZE;
    /**
     * The Text color normal.
     */
    protected int textColorNormal = WheelViews.TEXT_COLOR_NORMAL;
    /**
     * The Text color focus.
     */
    protected int textColorFocus = WheelViews.TEXT_COLOR_FOCUS;
    /**
     * The Line color.
     */
    protected int lineColor = WheelViews.LINE_COLOR;
    /**
     * The Line visible.
     */
     ...
     * The Offset.
     */
    protected int offset = WheelViews.OFF_SET;
